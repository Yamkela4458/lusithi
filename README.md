...
- Digital learning platforms and tools designed to support learners and educators  
- Web-based educational applications built with a focus on accessibility and usability  
- Research-support and learning-organisation tools for academic contexts  
- Examples of how frontend development principles are applied in educational settings  
